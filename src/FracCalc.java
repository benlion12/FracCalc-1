 ...
 * @author  Ronak Sheth
 *
 * This program calculates integers, mixed fractions, improper fractions, and fractions.
 * Simply run, and enter your equation in the format of "x_y/z + a_b/c"
 * This program currently only handles two operands
 */
import java.util.*;
